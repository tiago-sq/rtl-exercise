...
describe('Testes da aplicação', () => {
  ...
  */
  ...
  test.todo('5 - Conferir se um número é gerado na tela do jogo.');
  //Neste teste você irá querer utilizar um mock para a função que gera o número.

  test.todo('6 - Conferir se o jogo retorna a mensagem "Acertou" ao clicar na opção correta.');
  //Neste teste você irá querer utilizar um mock para a função que gera o número.

  test.todo('7 - Conferir se o jogo retorna a mensagem "Errou" ao clicar na opção incorreta.');
  //Neste teste você irá querer utilizar um mock para a função que gera o número.
});